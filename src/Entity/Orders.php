...
class Orders
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=CouponsTypes::class, inversedBy="orders")
     */
    private $coupons;
    ...
    public function getCoupons(): ?CouponsTypes
    {
        return $this->coupons;
    }

    public function setCoupons(?CouponsTypes $coupons): self
    {
